...
//       expect(findBodyContainer().findComponent(DummyComponent).exists()).toBe(
//         true,
//       )
//     })
//   })
...
//     beforeEach(() => {
//       createComponent({
//         propsData: { secondaryButtonText, secondaryButtonLink },
//       })
//     })
...
//         expect(wrapper.find(`[aria-live="${assertiveness}"`).exists()).toBe(
//           true,
//         )
//       },
//     )
