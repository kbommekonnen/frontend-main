...
// populate props data to store
function populateData() {
  accountId.value = props.account._id;
  store.code = props.account.code;
  store.name = props.account.name;
  store.side = props.account.side;
  store.isSubAccount = props.account.isSubAccount;
  if(props.account.isSubAccount) {
    store.parent = typeof props.account.parent == "object" ? props.account.parent._id : props.account.parent
  }
}
