      ...
      <div class="container">
        <div class="row full-height justify-content-center">
          <div class="col-12 text-center align-self-center py-5">
            <div class="flex justify-around w-full text-center py-5 py-md-0">
              <!-- <input
                class="pricing"
                type="checkbox"
                id="pricing"
              ...
              <!-- <label for="pricing"
                ><span class="block-diff"
                  >starter<span class="float-right">Business</span></span
                ></label
              > -->
              <div class="card-3d-wrap mx-auto">
                <div class="card-3d-wrapper">
                  <div class="card-front">
                    <div class="pricing-wrap space-y-4 ">
                      <h4 class="mb-5">Starter</h4>
                      <h2 class="flex space-x-2 mb-2">
                        <!-- <div>500</div> -->
                        <div class="text-lg">ETB</div>
                      </h2>
                      <p class="mb-4">per month</p>
                      <p class="mb-1">
                        <i class="uil uil-location-pin-alt size-22"></i>
                      </p>
                      <p class="mb-4">Perfect for small businesses</p>
                      <a href="#0" class="link">Get Trial</a>
                ...
                <div class="card-3d-wrapper">
                  <div class="card-front">
                    <div class="pricing-wrap space-y-4 ">
                      ...
                      <p class="mb-4">Great for growing businesses</p>
                      <a href="#0" class="link">Get Trial</a>
                      <!-- <div  class="img-wrap img-2">
                        <img
                          src="https://assets.codepen.io/1462889/sea.png"
              ...
              <div class="card-3d-wrap mx-auto">
                <div class="card-3d-wrapper">
                  <div class="card-front">
                    <div class="pricing-wrap space-y-4 ">
                      <h4 class="mb-5">Enterprise</h4>
                      <p class="mb-1">
                        <i class="uil uil-location-pin-alt size-22"></i>
                      </p>
                      <p class="mb-4">Customized solution for large enterprises</p>
                      <a href="#0" class="link">Contact us</a>
                      <!-- <div  class="img-wrap img-2">
                        <img
                          src="https://assets.codepen.io/1462889/sea.png"
                          alt=""
